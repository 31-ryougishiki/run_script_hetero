...
def parse_args():
    ...
    parser.add_argument(
        ...
        help=("Comma-separated per-DP tensor parallel sizes, e.g. 3,4,4,4. "
              "When set, --heterogeneous-dp-config is generated automatically."),
    )
    ...
    parser.add_argument("--kv-role", type=str, default="kv_producer",
                        choices=("kv_producer", "kv_consumer"),
                        help="KV connector role of this node.")
    parser.add_argument("--kv-port", type=int, default=36000,
                        help="Base handshake port of this node.")
    parser.add_argument("--engine-id", type=str, default="0",
                        help="KV connector engine id.")
    parser.add_argument("--prefill-dp-size", type=int, default=None,
                        help="Remote prefill pool DP size (defaults to --dp-size).")
    parser.add_argument("--prefill-tp-size", type=int, default=None,
    ...
    parser.add_argument("--decode-dp-size", type=int, default=None,
                        help="Remote decode pool DP size.")
